...
public abstract class FeedMessageModel
{
    ...
    public MessageType GetMessageType() => TopicParsingHelper.GetMessageType(RoutingKey);

    public URN GetSportURNFromRoutingKey() => TopicParsingHelper.GetSportURN(RoutingKey);
}
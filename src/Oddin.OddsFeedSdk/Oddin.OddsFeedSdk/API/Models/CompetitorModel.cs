...
namespace Oddin.OddsFeedSdk.API.Models
{
    ...
    public partial class competitorProfileEndpoint : Entities.Abstractions.ITeam
    {
        ...
        [XmlArray("players")]
        [XmlArrayItem("player")]
        public List<PlayerWithSport> players { get; set; }
    ...
    public class PlayerWithSport : player_profilePlayer
    {
        /// <remarks/>
